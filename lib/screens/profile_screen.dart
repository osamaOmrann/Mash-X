                      ...
                      FutureBuilder<QuerySnapshot<Company>>(
                        builder: (buildContext, snapshot) {
                          ...
                          var data = snapshot.data?.docs
                              ...
                              .toList();
                          return SizedBox(
                            height: height * userData['work_history'].length / 50,
                            child: ListView.builder(
                              physics: BouncingScrollPhysics(),
                              itemBuilder: (buildContext, index) {
                                return data.isEmpty
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              for (int i = 0;
                                  ...
                                  i++)
                                Container(
                                  padding: EdgeInsets.only(left: width * .041, top: height * .01, bottom: height * .01, right: width * .015),
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            List newSkills = userData['skills'];
                                            newSkills.remove(userData['skills'][i]);
                                            DataBase.updateUserData(DataBase.user.uid, 'skills', newSkills);
                                          },
                                        ...
                                        ElevatedButton(
                                            ...
                                            onPressed: () {
                                              if (_formKey.currentState!.validate()) {
                                                List newSkills = userData['skills'];
                                                newSkills.add(skillController.text);
                                                DataBase.updateUserData(DataBase.user.uid, 'skills', newSkills);
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          List newIntendedJobs = userData['intended_jobs'];
                                          newIntendedJobs.remove(userData['intended_jobs'][i]);
                                          DataBase.updateUserData(DataBase.user.uid, 'intended_jobs', newIntendedJobs);
                                        },
                                        child: Icon(CupertinoIcons.xmark_circle_fill),
                                      )
                                    ],
                                        ...
                                        ElevatedButton(
                                            ...
                                            onPressed: () {
                                              if (_jobFormKey.currentState!.validate()) {
                                                List newIntendedJobs = userData['intended_jobs'];
                                                newIntendedJobs.add(jobController.text);
                                                DataBase.updateUserData(DataBase.user.uid, 'intended_jobs', newIntendedJobs);
                                                Navigator.pop(context);
                                                jobController.clear();
                                              } else {
